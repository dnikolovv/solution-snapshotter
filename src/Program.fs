...
let generateTemplate (args:ParseResults<Arguments>) =
    ...
    (pathToSln, templateZipPath, vsixCsprojPath)
...
let main argv =
    try
        ...
        let (pathToSln, templateZipPath, vsixCsprojPath) = generateTemplate args
